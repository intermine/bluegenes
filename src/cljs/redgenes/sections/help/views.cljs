...
(defn main []
  (fn []
    [:div.approot.red
     ...
     [:h3 "Licence"]
     [:p "RedGenes, like InterMine, is released under the "[:a {:href "https://tldrlegal.com/license/gnu-lesser-general-public-license-v2.1-(lgpl-2.1)"}"LGPL 2.1 licence"]"."]
     ]))
