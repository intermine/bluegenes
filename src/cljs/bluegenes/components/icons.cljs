...
(defn icons []
  [:svg
   ...
   [:defs
    ...
    [:symbol#icon-drawer {:view-box "0 0 32 32"}
     [:title "drawer"]
    ...
    [:symbol#icon-spinner {:view-box "0 0 32 32"}
     [:title "spinner"]
    ...
    [:symbol#copy {:view-box "0 0 32 32"}
     [:title "copy"]
     [:path {:fill "black"
    ...
    [:symbol#icon-document-list {:viewBox "0 0 32 32"}
     [:title "document-list"]
    ...
    [:symbol#icon-venn-subtract {:view-box "0 0 100 125"}
     [:g
      [:path {:fill "rgb(170,170,170)"
              :d "M61.058,50c0,9.315-4.612,17.547-11.672,22.555c4.512,3.201,10.02,5.088,15.972,5.088C80.623,77.643,93,65.268,93,50      c0-15.267-12.377-27.643-27.643-27.643c-5.952,0-11.46,1.887-15.972,5.088C56.445,32.453,61.058,40.685,61.058,50z"}]
      [:path {:fill "rgb(170,170,170)"
              :d "M38.943,50c0-9.315,4.612-17.547,11.671-22.555c-4.511-3.201-10.019-5.088-15.971-5.088C19.377,22.357,7,34.733,7,50      c0,15.268,12.377,27.643,27.643,27.643c5.952,0,11.46-1.887,15.971-5.088C43.555,67.547,38.943,59.315,38.943,50z"}]]]
    ...
    [:symbol#icon-close
     ...
     [:path
      {:d
       "M15.854 12.854c-0-0-0-0-0-0l-4.854-4.854 4.854-4.854c0-0 0-0 0-0 0.052-0.052 0.090-0.113 0.114-0.178 0.066-0.178 0.028-0.386-0.114-0.529l-2.293-2.293c-0.143-0.143-0.351-0.181-0.529-0.114-0.065 0.024-0.126 0.062-0.178 0.114 0 0-0 0-0 0l-4.854 4.854-4.854-4.854c-0-0-0-0-0-0-0.052-0.052-0.113-0.090-0.178-0.114-0.178-0.066-0.386-0.029-0.529 0.114l-2.293 2.293c-0.143 0.143-0.181 0.351-0.114 0.529 0.024 0.065 0.062 0.126 0.114 0.178 0 0 0 0 0 0l4.854 4.854-4.854 4.854c-0 0-0 0-0 0-0.052 0.052-0.090 0.113-0.114 0.178-0.066 0.178-0.029 0.386 0.114 0.529l2.293 2.293c0.143 0.143 0.351 0.181 0.529 0.114 0.065-0.024 0.126-0.062 0.178-0.114 0-0 0-0 0-0l4.854-4.854 4.854 4.854c0 0 0 0 0 0 0.052 0.052 0.113 0.090 0.178 0.114 0.178 0.066 0.386 0.029 0.529-0.114l2.293-2.293c0.143-0.143 0.181-0.351 0.114-0.529-0.024-0.065-0.062-0.126-0.114-0.178z"}]] [:symbol#icon-sad
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      {:viewBox "0 0 16 16"}
